...
class DCAM():
    ...
    def __compute_permutations(self,instance, nb_permutation,label_instance):
        ...
        if np.std(all_pred_class) == 0 and label_instance==all_pred_class[0]:
            #verbose
            ...
            #if all_pred_class.count(label_instance)==0:
            #    print("No correctly classified permutation on the last sample")
