...
def objective(trial):
    ...
    TRIAL_number_of_layers = trial.suggest_int("num_layers",1,6)
    ...
    TRIAL_num_epochs = trial.suggest_int("num_epochs",10,100,15)
...
with open("results_transformer.txt","a") as f:
